...
pub fn words_from_le_bytes_32(bytes: &[u8; 32]) -> [u32; 8] {
    ...
    out[2] = u32::from_le_bytes(*array_ref!(bytes, 8, 4));
    out[3] = u32::from_le_bytes(*array_ref!(bytes, 12, 4));
    out[4] = u32::from_le_bytes(*array_ref!(bytes, 16, 4));
    out[5] = u32::from_le_bytes(*array_ref!(bytes, 20, 4));
    out[6] = u32::from_le_bytes(*array_ref!(bytes, 24, 4));
    out[7] = u32::from_le_bytes(*array_ref!(bytes, 28, 4));
    out
}
...
pub fn words_from_le_bytes_64(bytes: &[u8; 64]) -> [u32; 16] {
    ...
    out[6] = u32::from_le_bytes(*array_ref!(bytes, 24, 4));
    out[7] = u32::from_le_bytes(*array_ref!(bytes, 28, 4));
    out[8] = u32::from_le_bytes(*array_ref!(bytes, 32, 4));
    out[9] = u32::from_le_bytes(*array_ref!(bytes, 36, 4));
    out[10] = u32::from_le_bytes(*array_ref!(bytes, 40, 4));
    out[11] = u32::from_le_bytes(*array_ref!(bytes, 44, 4));
    out[12] = u32::from_le_bytes(*array_ref!(bytes, 48, 4));
    out[13] = u32::from_le_bytes(*array_ref!(bytes, 52, 4));
    out[14] = u32::from_le_bytes(*array_ref!(bytes, 56, 4));
    out[15] = u32::from_le_bytes(*array_ref!(bytes, 60, 4));
    out
}
...
pub fn le_bytes_from_words_32(words: &[u32; 8]) -> [u8; 32] {
    ...
    *array_mut_ref!(out, 8, 4) = words[2].to_le_bytes();
    *array_mut_ref!(out, 12, 4) = words[3].to_le_bytes();
    *array_mut_ref!(out, 16, 4) = words[4].to_le_bytes();
    *array_mut_ref!(out, 20, 4) = words[5].to_le_bytes();
    *array_mut_ref!(out, 24, 4) = words[6].to_le_bytes();
    *array_mut_ref!(out, 28, 4) = words[7].to_le_bytes();
    out
}
...
pub fn le_bytes_from_words_64(words: &[u32; 16]) -> [u8; 64] {
    ...
    *array_mut_ref!(out, 24, 4) = words[6].to_le_bytes();
    *array_mut_ref!(out, 28, 4) = words[7].to_le_bytes();
    *array_mut_ref!(out, 32, 4) = words[8].to_le_bytes();
    *array_mut_ref!(out, 36, 4) = words[9].to_le_bytes();
    *array_mut_ref!(out, 40, 4) = words[10].to_le_bytes();
    *array_mut_ref!(out, 44, 4) = words[11].to_le_bytes();
    *array_mut_ref!(out, 48, 4) = words[12].to_le_bytes();
    *array_mut_ref!(out, 52, 4) = words[13].to_le_bytes();
    *array_mut_ref!(out, 56, 4) = words[14].to_le_bytes();
    *array_mut_ref!(out, 60, 4) = words[15].to_le_bytes();
    out
}
