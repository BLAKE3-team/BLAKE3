...
fn test_parse_check_line() {
    ...
    .unwrap();
    assert_eq!(h, blake3::Hash::from([0xfa; 32]));
    assert_eq!(p, "fo \to");
    ...
    .unwrap();
    assert_eq!(h, blake3::Hash::from([0x42; 32]));
    assert_eq!(p, " ");
    ...
    if cfg!(not(windows)) {
        ...
        .unwrap();
        assert_eq!(h, blake3::Hash::from([0x43; 32]));
        assert_eq!(p, "fo\\a\\no");
    }
    ...
    .unwrap();
    assert_eq!(h, blake3::Hash::from([0x44; 32]));
    assert_eq!(p, "fo\n\no");
    ...
    if cfg!(not(windows)) {
        ...
        .unwrap();
        assert_eq!(h, blake3::Hash::from([0x45; 32]));
        assert_eq!(p, "fo\n\\o");
    }
    ...
    .unwrap();
    assert_eq!(h, blake3::Hash::from([0x46; 32]));
    assert_eq!(p, "否认");
